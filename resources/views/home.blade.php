...
@section('title', 'SakuraRead - Tu destino de Novelas Ligeras')
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6 mb-12">
                     ...
                     <div class="group cursor-pointer">
                        <div class="relative aspect-[3/4.5] rounded-xl md:rounded-2xl overflow-hidden mb-3 shadow-xl bg-slate-800">
                            <div class="absolute top-2 left-2 md:top-3 md:left-3 z-10 glass rounded-lg px-2 py-1 flex items-center gap-1 border border-primary/30">
                                ...
                                <span class="text-[9px] md:text-[10px] font-bold text-white">Hace 2h</span>
                            </div>
                        ...
                        <p class="text-slate-500 text-[10px] md:text-xs mt-1">Capítulo 245</p>
                    </div>
                     ...
                     <div class="group cursor-pointer">
                        <div class="relative aspect-[3/4.5] rounded-xl md:rounded-2xl overflow-hidden mb-3 shadow-xl bg-slate-800">
                             <div class="absolute top-2 left-2 md:top-3 md:left-3 z-10 glass rounded-lg px-2 py-1 flex items-center gap-1 border border-indigo-400/30">
                                <span class="text-[9px] md:text-[10px] font-bold text-white">Hace 5h</span>
                            </div>
                        ...
                        <p class="text-slate-500 text-[10px] md:text-xs mt-1">Capítulo 18</p>
                    </div>
                    ...
                    <div class="group cursor-pointer">
                        <div class="relative aspect-[3/4.5] rounded-xl md:rounded-2xl overflow-hidden mb-3 shadow-xl bg-slate-800">
                            <div class="absolute top-2 left-2 md:top-3 md:left-3 z-10 glass rounded-lg px-2 py-1 flex items-center gap-1 border border-primary/30">
                                <span class="text-[9px] md:text-[10px] font-bold text-white">Ayer</span>
                            </div>
                        ...
                        <p class="text-slate-500 text-[10px] md:text-xs mt-1">Capítulo 89</p>
                    </div>
                    ...
                    <div class="group cursor-pointer">
                        ...
                        <p class="text-slate-500 text-[10px] md:text-xs mt-1">Capítulo 142</p>
                    </div>
                    ...
                    <div class="hidden sm:block group cursor-pointer">
                        <div class="relative aspect-[3/4.5] rounded-xl md:rounded-2xl overflow-hidden mb-3 shadow-xl bg-slate-800">
                             <div class="absolute top-2 left-2 md:top-3 md:left-3 z-10 glass rounded-lg px-2 py-1 flex items-center gap-1 border border-primary/30">
                                <span class="text-[9px] md:text-[10px] font-bold text-white">Hace 2d</span>
                            </div>
                        ...
                        <p class="text-slate-500 text-[10px] md:text-xs mt-1">Capítulo 45</p>
                    </div>
                </div>

                {{-- Genres Section --}}
                <div class="mt-12 md:mt-16 mb-8 md:mb-0">
                    <h3 class="text-xl md:text-2xl font-display font-bold mb-6 md:mb-8">Explorar por Género</h3>
                    <div class="flex flex-wrap gap-3 md:gap-4">
                        ...
                        <div class="px-5 md:px-8 py-3 md:py-4 glass rounded-xl md:rounded-2xl text-slate-300 text-sm font-bold cursor-pointer hover:bg-white/5 transition-all">Sci-Fi</div>
                        <div class="px-5 md:px-8 py-3 md:py-4 glass rounded-xl md:rounded-2xl text-slate-300 text-sm font-bold cursor-pointer hover:bg-white/5 transition-all">Escolar</div>
                    </div>
                </div>
            </div>
            ...
            <aside class="w-full lg:w-80 shrink-0">
                <div class="lg:sticky lg:top-24">
                    ...
                    <div class="hidden md:block mt-8 glass rounded-2xl p-6 bg-gradient-to-br from-primary/20 to-indigo-900/40 border border-primary/20">
                        <h5 class="font-display font-bold text-lg mb-2">Hazte Premium</h5>
                        <p class="text-xs text-slate-300 mb-4">Accede a mas capítulos y sin publicidad.</p>
                        <button class="w-full py-2 glass rounded-lg text-xs font-bold hover:bg-white/10 transition-all">Ver Planes</button>
                    </div>
                </div>
            </aside>
        </div>
